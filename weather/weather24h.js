...
function getWeather(cityTag,key,callback){
    // 获取今天的天气
    var urlnow = 'https://devapi.qweather.com/v7/weather/24h?location='+cityTag+'&key='+key
    axios.get(urlnow).then(res=>{
        return callback(res.data.hourly);
    },err=>{
        console.log(err);
    })
}
